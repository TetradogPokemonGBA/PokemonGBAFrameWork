...
namespace PokemonGBAFramework.Core.ComandosScript
{
	...
	public class SetWildBattle:Comando
	{
		...
		{
			return new Gabriel.Cat.S.Utilitats.Propiedad[]{ new Gabriel.Cat.S.Utilitats.Propiedad(this, nameof(Pokemon)), new Gabriel.Cat.S.Utilitats.Propiedad(this, nameof(Nivel)), new Gabriel.Cat.S.Utilitats.Propiedad(this, nameof(Objeto)) };
		}

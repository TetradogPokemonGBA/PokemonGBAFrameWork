...
namespace PokemonGBAFramework.Core.ComandosScript
{
	...
	public class SpriteBehave:Comando
	{
		...
		{
			return new Gabriel.Cat.S.Utilitats.Propiedad[]{ new Gabriel.Cat.S.Utilitats.Propiedad(this, nameof(Personaje)), new Gabriel.Cat.S.Utilitats.Propiedad(this, nameof(Comportamiento)) };
		}

...
namespace PokemonGBAFramework.Core.ComandosScript
{
	...
	public class Warp8:Comando
	{
		...
		public Warp8(Byte bancoAIr, Byte mapaAIr, Byte salidaAIr, Word coordenadaX, Word coordenadaY)
		{
			BancoAIr = bancoAIr;
			MapaAIr = mapaAIr;
			SalidaAIr = salidaAIr;
		...
		public Warp8(ScriptManager scriptManager,RomGba rom, int offset)
			 : base(scriptManager,rom, offset)
		{
		}
		public Warp8(ScriptManager scriptManager,byte[] bytesScript, int offset)
			: base(scriptManager,bytesScript, offset)
		{
		}
		public unsafe Warp8(ScriptManager scriptManager,byte* ptRom, int offset)

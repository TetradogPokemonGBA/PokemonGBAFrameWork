...
namespace PokemonGBAFramework.Core.ComandosScript
{
	...
	public class SpriteLevelUp:Comando
	{
		...
		{
			return new Gabriel.Cat.S.Utilitats.Propiedad[]{ new Gabriel.Cat.S.Utilitats.Propiedad(this, nameof(Personaje)), new Gabriel.Cat.S.Utilitats.Propiedad(this, nameof(Banco)), new Gabriel.Cat.S.Utilitats.Propiedad(this, nameof(Mapa)), new Gabriel.Cat.S.Utilitats.Propiedad(this, nameof(Unknow)) };
		}

...
namespace PokemonGBAFramework.Core.ComandosScript
{
	...
	public class SetDoorClosed2:Comando
	{
		...
		public SetDoorClosed2(ScriptManager scriptManager,RomGba rom, int offset)
			 : base(scriptManager,rom, offset)
		{
		}
		public SetDoorClosed2(ScriptManager scriptManager,byte[] bytesScript, int offset)
			: base(scriptManager,bytesScript, offset)
		{
		}
		public unsafe SetDoorClosed2(ScriptManager scriptManager,byte* ptRom, int offset)

...
namespace PokemonGBAFramework.Core.ComandosScript
{
	...
	public class Multichoice3:Comando
	{
		...
		public Multichoice3(ScriptManager scriptManager,RomGba rom, int offset)
			 : base(scriptManager,rom, offset)
		{
		}
		public Multichoice3(ScriptManager scriptManager,byte[] bytesScript, int offset)
			: base(scriptManager,bytesScript, offset)
		{
		}
		public unsafe Multichoice3(ScriptManager scriptManager,byte* ptRom, int offset)

...
namespace PokemonGBAFramework.Core.ComandosScript
{
	...
	public class PayMoney:Comando
	{
		...
		{
			return new Gabriel.Cat.S.Utilitats.Propiedad[]{ new Gabriel.Cat.S.Utilitats.Propiedad(this, nameof(DineroACoger)), new Gabriel.Cat.S.Utilitats.Propiedad(this, nameof(ComprobarEjecucionComando))};
		}

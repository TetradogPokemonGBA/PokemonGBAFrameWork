...
namespace PokemonGBAFramework.Core.ComandosScript
{
	...
	public class PrepareMsg2:Comando
	{
		...
		public PrepareMsg2(ScriptManager scriptManager,RomGba rom, int offset)
			 : base(scriptManager,rom, offset)
		{
		}
		public PrepareMsg2(ScriptManager scriptManager,byte[] bytesScript, int offset)
			: base(scriptManager,bytesScript, offset)
		{
		}
		public unsafe PrepareMsg2(ScriptManager scriptManager,byte* ptRom, int offset)

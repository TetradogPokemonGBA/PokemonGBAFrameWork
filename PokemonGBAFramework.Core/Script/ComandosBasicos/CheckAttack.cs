...
namespace PokemonGBAFramework.Core.ComandosScript
{
	...
	public class CheckAttack:Comando
	{
		...
		public CheckAttack(ScriptManager scriptManager,RomGba rom,int offset):base(scriptManager,rom,offset)
		{
		}
		public CheckAttack(ScriptManager scriptManager,byte[] bytesScript,int offset):base(scriptManager,bytesScript,offset)
		{}
		public unsafe CheckAttack(ScriptManager scriptManager,byte* ptRom,int offset):base(scriptManager,ptRom,offset)
		{}
		...
		public override byte[] GetBytesTemp()
		{
			...
			Word.SetData(data, ,AtaqueAComprobar);			
		}
	}
}

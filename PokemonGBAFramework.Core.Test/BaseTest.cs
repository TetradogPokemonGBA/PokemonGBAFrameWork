...
namespace PokemonGBAFramework.Core.Test.Batalla
{
    ...
    public abstract class BaseTestIndividual
    {
        ...
        [TestMethod]
        public void TestGetIndividualVerdeHojaITA() => TestGetIndividual(Resource1.VerdeHojaITA);
    ...
    public abstract class BaseTest:BaseTestIndividual
    {
        ...
        [TestMethod]
        public void TestGetTodosVerdeHojaITA() => TestGetTodos(Resource1.VerdeHojaITA);
        #endregion

    ...
    /*  class BloqueSonido
      {
          ...
          public static BloqueSonido GetBloqueSonido(RomData rom, Hex offsetSound)
          {//por descubrir
              ...
              bloqueACargar.Length = Serializar.ToInt(rom.RomGBA.Datos.SubArray((int)offsetSound+(int)Posicion.Length,sizeof(int)));//habra una lenght para cada canal?
              unsafe
              {

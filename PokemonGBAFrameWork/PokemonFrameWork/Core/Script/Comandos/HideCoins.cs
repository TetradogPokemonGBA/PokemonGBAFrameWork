...
namespace PokemonGBAFrameWork.ComandosScript
{
 ...
 CoordenadaY=coordenadaY;
  ...
  public HideCoins(RomGba rom,int offset):base(rom,offset)
  {
  }
  public HideCoins(byte[] bytesScript,int offset):base(bytesScript,offset)
  {}
  public unsafe HideCoins(byte* ptRom,int offset):base(ptRom,offset)
  {}

...
namespace PokemonGBAFrameWork.ComandosScript
{
 ...
 Orientacion=orientacion;
  ...
  public CreateSprite(RomGba rom,int offset):base(rom,offset)
  {
  }
  public CreateSprite(byte[] bytesScript,int offset):base(bytesScript,offset)
  {}
  public unsafe CreateSprite(byte* ptRom,int offset):base(ptRom,offset)
  {}
...
set{orientacion=value;}
  ...
  {
   return new Object[]{spriteAUsar,personajeVirtual,coordenadaX,coordenadaY,comportamiento,orientacion};
  }

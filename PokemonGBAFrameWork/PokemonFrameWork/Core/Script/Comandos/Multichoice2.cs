...
namespace PokemonGBAFrameWork.ComandosScript
{
 ...
 BotonBCancela=botonBCancela;
  ...
  public Multichoice2(RomGba rom,int offset):base(rom,offset)
  {
  }
  public Multichoice2(byte[] bytesScript,int offset):base(bytesScript,offset)
  {}
  public unsafe Multichoice2(byte* ptRom,int offset):base(ptRom,offset)
  {}
...
set{botonBCancela=value;}
  ...
  {
   return new Object[]{coordenadaX,coordenadaY,idLista,opcionPorDefecto,botonBCancela};
  }

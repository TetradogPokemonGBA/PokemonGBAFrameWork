...
namespace PokemonGBAFrameWork.ComandosScript
{
 ...
 public class PrepareMsg3:Comando
 {
  ...
  public PrepareMsg3(RomGba rom,int offset):base(rom,offset)
  {
  }
  public PrepareMsg3(byte[] bytesScript,int offset):base(bytesScript,offset)
  {}
  public unsafe PrepareMsg3(byte* ptRom,int offset):base(ptRom,offset)
  {}
...
set{texto=value;}
  ...
  {
   return new Object[]{texto.Offset};
  }

...
namespace PokemonGBAFrameWork.ComandosScript
{
 ...
 ComprobarEjecucionComando=comprobarEjecucionComando;
  ...
  public UpdateMoney(RomGba rom,int offset):base(rom,offset)
  {
  }
  public UpdateMoney(byte[] bytesScript,int offset):base(bytesScript,offset)
  {}
  public unsafe UpdateMoney(byte* ptRom,int offset):base(ptRom,offset)
  {}

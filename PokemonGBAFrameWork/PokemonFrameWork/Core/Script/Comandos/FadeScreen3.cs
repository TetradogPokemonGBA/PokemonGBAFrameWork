...
namespace PokemonGBAFrameWork.ComandosScript
{
 ...
 public class FadeScreen3:Comando
 {
  ...
  public FadeScreen3(RomGba rom,int offset):base(rom,offset)
  {
  }
  public FadeScreen3(byte[] bytesScript,int offset):base(bytesScript,offset)
  {}
  public unsafe FadeScreen3(byte* ptRom,int offset):base(ptRom,offset)
  {}

...
namespace PokemonGBAFrameWork.ComandosScript
{
 ...
 Alto=alto;
  ...
  public ShowBox(RomGba rom,int offset):base(rom,offset)
  {
  }
  public ShowBox(byte[] bytesScript,int offset):base(bytesScript,offset)
  {}
  public unsafe ShowBox(byte* ptRom,int offset):base(ptRom,offset)
  {}

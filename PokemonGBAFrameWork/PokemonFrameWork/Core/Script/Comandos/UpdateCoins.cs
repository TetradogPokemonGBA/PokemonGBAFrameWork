...
namespace PokemonGBAFrameWork.ComandosScript
{
 ...
 CoordenadaY=coordenadaY;
  ...
  public UpdateCoins(RomGba rom,int offset):base(rom,offset)
  {
  }
  public UpdateCoins(byte[] bytesScript,int offset):base(bytesScript,offset)
  {}
  public unsafe UpdateCoins(byte* ptRom,int offset):base(ptRom,offset)
  {}

...
namespace PokemonGBAFrameWork.ComandosScript
{
 ...
 public class HideSprite:Comando
 {
  ...
  public HideSprite(RomGba rom,int offset):base(rom,offset)
  {
  }
  public HideSprite(byte[] bytesScript,int offset):base(bytesScript,offset)
  {}
  public unsafe HideSprite(byte* ptRom,int offset):base(ptRom,offset)
  {}

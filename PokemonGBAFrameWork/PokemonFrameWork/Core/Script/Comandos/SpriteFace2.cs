...
namespace PokemonGBAFrameWork.ComandosScript
{
 ...
 Orientacion=orientacion;
  ...
  public SpriteFace2(RomGba rom,int offset):base(rom,offset)
  {
  }
  public SpriteFace2(byte[] bytesScript,int offset):base(bytesScript,offset)
  {}
  public unsafe SpriteFace2(byte* ptRom,int offset):base(ptRom,offset)
  {}

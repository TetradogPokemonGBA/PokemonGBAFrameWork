...
namespace PokemonGBAFrameWork.ComandosScript
{
 ...
 ComprobarEjecucionComando=comprobarEjecucionComando;
  ...
  public ShowMoney(RomGba rom,int offset):base(rom,offset)
  {
  }
  public ShowMoney(byte[] bytesScript,int offset):base(bytesScript,offset)
  {}
  public unsafe ShowMoney(byte* ptRom,int offset):base(ptRom,offset)
  {}

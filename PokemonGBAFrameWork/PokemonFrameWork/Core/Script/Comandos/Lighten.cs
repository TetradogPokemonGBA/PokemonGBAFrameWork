...
namespace PokemonGBAFrameWork.ComandosScript
{
 ...
 public class Lighten:Comando
 {
  ...
  public Lighten(RomGba rom,int offset):base(rom,offset)
  {
  }
  public Lighten(byte[] bytesScript,int offset):base(bytesScript,offset)
  {}
  public unsafe Lighten(byte* ptRom,int offset):base(ptRom,offset)
  {}

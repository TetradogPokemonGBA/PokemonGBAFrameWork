...
namespace PokemonGBAFrameWork.ComandosScript
{
 ...
 public class TextColor:Comando
 {
  ...
  public TextColor(RomGba rom,int offset):base(rom,offset)
  {
  }
  public TextColor(byte[] bytesScript,int offset):base(bytesScript,offset)
  {}
  public unsafe TextColor(byte* ptRom,int offset):base(ptRom,offset)
  {}

...
namespace PokemonGBAFrameWork.ComandosScript
{
 ...
 CoordenadaY=coordenadaY;
  ...
  public ShowCoins(RomGba rom,int offset):base(rom,offset)
  {
  }
  public ShowCoins(byte[] bytesScript,int offset):base(bytesScript,offset)
  {}
  public unsafe ShowCoins(byte* ptRom,int offset):base(ptRom,offset)
  {}

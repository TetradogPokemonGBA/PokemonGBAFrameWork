...
namespace PokemonGBAFrameWork.ComandosScript
{
 ...
 public class VirtualMsgBox:Comando
 {
  ...
  public VirtualMsgBox(RomGba rom,int offset):base(rom,offset)
  {
  }
  public VirtualMsgBox(byte[] bytesScript,int offset):base(bytesScript,offset)
  {}
  public unsafe VirtualMsgBox(byte* ptRom,int offset):base(ptRom,offset)
  {}

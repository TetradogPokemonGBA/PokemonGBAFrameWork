...
namespace PokemonGBAFrameWork.ComandosScript
{
 ...
 CoordenadaY=coordenadaY;
  ...
  public ShowPokePic(RomGba rom,int offset):base(rom,offset)
  {
  }
  public ShowPokePic(byte[] bytesScript,int offset):base(bytesScript,offset)
  {}
  public unsafe ShowPokePic(byte* ptRom,int offset):base(ptRom,offset)
  {}

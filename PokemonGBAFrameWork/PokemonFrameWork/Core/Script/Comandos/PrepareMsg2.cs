...
namespace PokemonGBAFrameWork.ComandosScript
{
 ...
 public class PrepareMsg2:Comando
 {
  ...
  public PrepareMsg2(RomGba rom,int offset):base(rom,offset)
  {
  }
  public PrepareMsg2(byte[] bytesScript,int offset):base(bytesScript,offset)
  {}
  public unsafe PrepareMsg2(byte* ptRom,int offset):base(ptRom,offset)
  {}
...
set{pointerTexto=value;}
  ...
  {
   return new Object[]{pointerTexto.Offset};
  }
  protected unsafe override void CargarCamando(byte* ptrRom, int offsetComando)
  {
   pointerTexto=new OffsetRom(ptrRom,new OffsetRom(ptrRom,offsetComando).Offset);

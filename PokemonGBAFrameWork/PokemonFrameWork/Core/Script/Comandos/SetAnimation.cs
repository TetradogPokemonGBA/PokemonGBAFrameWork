...
namespace PokemonGBAFrameWork.ComandosScript
{
 ...
 VariableAUsar=variableAUsar;
  ...
  public SetAnimation(RomGba rom,int offset):base(rom,offset)
  {
  }
  public SetAnimation(byte[] bytesScript,int offset):base(bytesScript,offset)
  {}
  public unsafe SetAnimation(byte* ptRom,int offset):base(ptRom,offset)
  {}

...
namespace PokemonGBAFrameWork.ComandosScript
{
 ...
 public class cmdA6:Comando
 {
  ...
  public cmdA6(RomGba rom,int offset):base(rom,offset)
  {
  }
  public cmdA6(byte[] bytesScript,int offset):base(bytesScript,offset)
  {}
  public unsafe cmdA6(byte* ptRom,int offset):base(ptRom,offset)
  {}

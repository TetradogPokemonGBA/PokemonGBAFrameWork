...
namespace PokemonGBAFrameWork.ComandosScript
{
	...
	public class YesNoBox:Comando
	{
		...
		public YesNoBox(RomGba rom,int offset):base(rom,offset)
		{
		}
		public YesNoBox(byte[] bytesScript,int offset):base(bytesScript,offset)
		{}
		public unsafe YesNoBox(byte* ptRom,int offset):base(ptRom,offset)
		{}

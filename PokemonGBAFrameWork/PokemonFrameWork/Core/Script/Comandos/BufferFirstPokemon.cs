...
namespace PokemonGBAFrameWork.ComandosScript
{
 ...
 public class BufferFirstPokemon:Comando
 {
  ...
  public BufferFirstPokemon(RomGba rom,int offset):base(rom,offset)
  {
  }
  public BufferFirstPokemon(byte[] bytesScript,int offset):base(bytesScript,offset)
  {}
  public unsafe BufferFirstPokemon(byte* ptRom,int offset):base(ptRom,offset)
  {}

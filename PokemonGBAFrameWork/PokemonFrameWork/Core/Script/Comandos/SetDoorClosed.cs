...
namespace PokemonGBAFrameWork.ComandosScript
{
 ...
 short coordenadaY;
  ...
  public SetDoorClosed(short coordenadaX,short coordenadaY) 
  {
 ...
 CoordenadaY=coordenadaY;
  ...
  public SetDoorClosed(RomGba rom,int offset):base(rom,offset)
  {
  }
  public SetDoorClosed(byte[] bytesScript,int offset):base(bytesScript,offset)
  {}
  public unsafe SetDoorClosed(byte* ptRom,int offset):base(ptRom,offset)
  {}

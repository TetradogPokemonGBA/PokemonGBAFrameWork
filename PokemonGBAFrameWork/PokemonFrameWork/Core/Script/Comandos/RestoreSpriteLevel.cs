...
namespace PokemonGBAFrameWork.ComandosScript
{
 ...
 Byte mapa;
  ...
  public RestoreSpriteLevel(short personaje,Byte banco,Byte mapa) 
  {
   Personaje=personaje;
 Banco=banco;
 Mapa=mapa;
  ...
  public RestoreSpriteLevel(RomGba rom,int offset):base(rom,offset)
  {
  }
  public RestoreSpriteLevel(byte[] bytesScript,int offset):base(bytesScript,offset)
  {}
  public unsafe RestoreSpriteLevel(byte* ptRom,int offset):base(ptRom,offset)
  {}

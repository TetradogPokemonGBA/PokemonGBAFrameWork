...
namespace PokemonGBAFrameWork.ComandosScript
{
 ...
 FuncionPersonalizada=funcionPersonalizada;
  ...
  public VirtualCallIf(RomGba rom,int offset):base(rom,offset)
  {
  }
  public VirtualCallIf(byte[] bytesScript,int offset):base(bytesScript,offset)
  {}
  public unsafe VirtualCallIf(byte* ptRom,int offset):base(ptRom,offset)
  {}

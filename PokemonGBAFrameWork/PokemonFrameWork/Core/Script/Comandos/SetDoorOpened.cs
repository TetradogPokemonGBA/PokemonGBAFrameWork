...
namespace PokemonGBAFrameWork.ComandosScript
{
 ...
 short coordenadaY;
  ...
  public SetDoorOpened(short coordenadaX,short coordenadaY) 
  {
 ...
 CoordenadaY=coordenadaY;
  ...
  public SetDoorOpened(RomGba rom,int offset):base(rom,offset)
  {
  }
  public SetDoorOpened(byte[] bytesScript,int offset):base(bytesScript,offset)
  {}
  public unsafe SetDoorOpened(byte* ptRom,int offset):base(ptRom,offset)
  {}

...
namespace PokemonGBAFrameWork.ComandosScript
{
 ...
 public class GiveCoins:Comando
 {
  ...
  public GiveCoins(RomGba rom,int offset):base(rom,offset)
  {
  }
  public GiveCoins(byte[] bytesScript,int offset):base(bytesScript,offset)
  {}
  public unsafe GiveCoins(byte* ptRom,int offset):base(ptRom,offset)
  {}

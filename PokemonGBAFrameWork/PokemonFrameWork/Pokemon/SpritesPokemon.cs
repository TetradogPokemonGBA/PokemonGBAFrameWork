...
namespace PokemonGBAFrameWork
{
	...
	public class SpritesPokemon
	{
		...
		public static SpritesPokemon GetSpritesPokemon(RomGba rom,int indexOrdenGameFreakPokemon)
		{
			...
			int offsetImgFrontalPokemon=  Zona.GetOffsetRom(ZonaImgFrontal,  rom).Offset+BloqueImagen.LENGTHHEADERCOMPLETO*indexOrdenGameFreakPokemon;
			...
			int offsetPaletaNormalPokemon=Zona.GetOffsetRom(ZonaPaletaNormal,rom).Offset+Paleta.LENGTHHEADERCOMPLETO*indexOrdenGameFreakPokemon;
			int offsetPaletaShinyPokemon= Zona.GetOffsetRom(ZonaPaletaShiny, rom).Offset+Paleta.LENGTHHEADERCOMPLETO*indexOrdenGameFreakPokemon;
		...
		public static void Remove(RomGba rom,  int indexOrdenGameFreakPokemon)
		{
			int offsetImgFrontalPokemon=Zona.GetOffsetRom(ZonaImgFrontal,rom).Offset+BloqueImagen.LENGTHHEADERCOMPLETO*indexOrdenGameFreakPokemon;
			int offsetImgTraseraPokemon=Zona.GetOffsetRom(ZonaImgTrasera, rom).Offset+BloqueImagen.LENGTHHEADERCOMPLETO*indexOrdenGameFreakPokemon;
			int offsetPaletaNormalPokemon=Zona.GetOffsetRom(ZonaPaletaNormal, rom).Offset+Paleta.LENGTHHEADERCOMPLETO*indexOrdenGameFreakPokemon;
